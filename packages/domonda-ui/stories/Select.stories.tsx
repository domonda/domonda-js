      ...
      <Flex item>
        <Button>
          <svg
            ...
            data-prefix="fas"
            data-icon="atom"
            className="svg-inline--fa fa-atom fa-w-14"
            role="img"
      ...
      <Flex item>
        <Button variant="primary" size="tiny">
          <svg
            ...
            className="svg-inline--fa fa-american-sign-language-interpreting fa-w-20"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
          >
